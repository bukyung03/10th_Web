      ...
      {confirmOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-4">
          <div className="w-full max-w-sm rounded-3xl border border-zinc-800 bg-zinc-950 p-6 text-white shadow-xl">
            <h2 className="text-xl font-semibold">정말 탈퇴하시겠습니까?</h2>
            ...
            <div className="mt-6 flex gap-3">
              <button
                ...
                className="flex-1 rounded-2xl border border-zinc-700 bg-zinc-900 px-4 py-3 text-sm text-white transition hover:border-pink-500 hover:text-pink-400"
              >
                취소
              </button>
              <button
                ...
                className="flex-1 rounded-2xl bg-pink-600 px-4 py-3 text-sm font-semibold text-white transition hover:bg-pink-500 disabled:cursor-not-allowed disabled:opacity-60"
              >
